...
- (void)showChart
{
    ...
    NSArray *xValue = @[@(10.0f), @(30.0f), @(40.0f), @(CGFLOAT_MIN), @(70.0f), @(90.0f), @(110.0f), @(150.0f), @(180.0f), @(180.0f)];
    NSArray *yValue = @[@(40.0f), @(30.0f), @(35.0f), @(CGFLOAT_MIN), @(50.0f), @(55.0f), @(55.0f), @(70.0f), @(100.0f), @(190.0f)];
    ...
    lineData2.cyclePointWidth = 4.0f;
    ...
    // 同时画两条曲线
    [chartView showLines:@[lineData, lineData2] withChartBound:CGRectMake(0.0f, 0.0f, 300.0f, 180.0f)];
    ...
    dispatch_after(delayTime1, dispatch_get_main_queue(), ^(void){
        ...
        NSArray *xValue4 = @[@(0.0f), @(20.0f),  @(CGFLOAT_MIN), @(30.0f), @(50.0f), @(60.0f), @(100.0f), @(CGFLOAT_MIN), @(130.0f), @(160.0f), @(240.0f)];
        NSArray *yValue4 = @[@(10.0f), @(30.0f),  @(CGFLOAT_MIN), @(40.0f), @(60.0f), @(150.0f), @(120.0f), @(CGFLOAT_MIN), @(130.0f), @(100.0f), @(140.0f)];
        JCLineData *lineData4 = [[JCLineData alloc] init];
        lineData4.lineColor = [UIColor blueColor];
        lineData4.lineWidth = 1.0f;
        lineData4.cyclePointWidth = 6.0f;
        lineData4.cyclePointFillColor = [UIColor colorWithRed:0.0f green:0.0f blue:1.0f alpha:0.3f];
