...
- (void)showChart
{
    ...
    NSArray *xValue = @[@(10.0f), @(30.0f), @(40.0f), @(70.0f), @(90.0f), @(110.0f), @(150.0f), @(180.0f), @(200.0f)];
    NSArray *yValue = @[@(10.0f), @(30.0f), @(35.0f), @(50.0f), @(55.0f), @(55.0f), @(70.0f), @(100.0f), @(170.0f)];
    ...
    NSArray *yValue2 = @[@(10.0f), @(30.0f), @(40.0f), @(50.0f), @(80.0f), @(100.0f), @(120.0f), @(130.0f), @(140.0f)];
